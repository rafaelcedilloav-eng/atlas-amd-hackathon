...
export default function DashboardPage() {
  ...
  return (
    <div className="relative w-screen h-screen bg-black overflow-hidden text-white">
      ...
      >
        {/* Header */}
        <header className="col-span-3 glass-mc flex justify-between items-center px-8">
        ...
        {/* Left nav */}
        <aside className="glass-mc flex flex-col">
        ...
        <aside className="glass-mc flex flex-col p-6">
        ...
        {/* Footer */}
        <footer className="col-span-3 grid grid-cols-2 gap-4">
